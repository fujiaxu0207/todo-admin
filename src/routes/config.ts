...
const menus: {
    ...
    menus: [
        ...
        { key: '/app/userTable', title: '用户管理', icon: 'mobile', component: 'UserTable' },
        { key: '/app/todoList', title: '代办管理', icon: 'mobile', component: 'TodoList' },
        // {
        //     key: '/app/ui',
        //     title: 'UI',
        //     icon: 'scan',
        ...
        //     icon: 'copy',
        //     subs: [
        //         { key: '/app/das', title: '基础表格', component: 'BasicTable' },
